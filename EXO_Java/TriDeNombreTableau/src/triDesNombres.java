...
public class triDesNombres {
	...
	public static int[] trierTableau(int[] tab) {
		...
		//tant que i est inferieur à la longueur du tableau
		//éffectue j=i+1
		//affecte false à finded
		//tant que j est inferieur à la longueur de tab et finded est false
		//si la valeur du tableau à l'index j est inferieur à l'index du tableau i
		//change les valeurs d'index dans le tableau et passe finded en true
		//incrémentation j
		//si finded est false incrémentation i
